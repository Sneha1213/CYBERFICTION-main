...
const projects: Project[] = [
  ...
  //     ],
  //   },
  //   live: "https://github.com/Seekerwillseek",
  //   github: "https://github.com/Seekerwillseek",
  //   get content() {
  //     return (
  //       <div>
  //         <TypographyP className="font-mono text-2xl text-center">
  ...
  //   live: "https://www.rutujadhage.com/",
  ...
  //       <div>
  //         <TypographyP className="font-mono ">
  //           Step into the digital world, the beloved DevOps guru and Spiritual 
  ...
  //           transforms lives. 💻🕊️ Crafted with ❤️ by Team nueral Ninjas 🚀
  //         </TypographyP>
  //         <ProjectsLinks live={this.live} repo={this.github} />
  //         <SlideShow
  //           images={[
